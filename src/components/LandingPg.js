        ...
        <div>
            ...
            <div className="container">
                <div className="col-sm-9 bg-white mt-4 p-4">
                    ...
                    <hr />
                    <div>
                        <img alt = "me"  src="https://media-exp1.licdn.com/dms/image/C4E35AQGAuS3atUIODg/profile-framedphoto-shrink_200_200/0?e=1597881600&v=beta&t=5txNYLDiyUktQznyj8abQMhnX4KvSSHyPH9g_gBCzrc" alt= "Me"
